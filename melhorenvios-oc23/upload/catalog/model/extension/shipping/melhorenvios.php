...
class ModelExtensionShippingMelhorenvios extends Model {
	function getQuote($address) {
		...
		$header = array('Accept: application/json', 'Content-Type: application/json;charset=UTF-8', 'Authorization: Bearer '. $token, 'User-Agent: OpenCart Master (suporte@opencartmaster.com.br)');
